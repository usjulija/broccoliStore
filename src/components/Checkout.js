    ...
    return (
      <div className={modalVisibility}>
        <div className="modal-content">
          ...
          <h5>
            You have selected <span>{this.props.totalItems}</span> product(s)
            for total price of <span>{formatPrice(this.props.totalPrice)}</span>
          </h5>
          <p>
            Sorry, it is just a store concept, you cannot buy anything here!
          </p>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="-28 0 411 411"
            width="250px"
          >
            <path
              fill="#61c5a8"
