const grocery = [
  ...
  },
  {
    ...
    price: 199,
    description:
      "Large organic vine tomatoes, grown by specially selected farmers with a commitment to quality. Delicious in salads or roasted in the oven.",
    discount: 0,
  ...
  },
  {
    ...
    price: 199,
    description:
      "Slice for salads, sandwiches, crudites & cocktail accompaniments. Organic, Grown without reliance on artificial chemicals.",
    discount: 10,
  ...
  },
  {
    ...
    price: 199,
    description:
      "Sweet and crisp, great in a salad or as a snack, just as good to cook with.",
    discount: 0,
  ...
  },
  {
    ...
    price: 149,
    description:
      "This is the milk that has been heated for 3 seconds at ultra high temperature. In such milk all valuable minerals and vitamins are preserved.",
    discount: 0,
  ...
  },
  {
    ...
    price: 169,
    description:
      "Actimel yogurt drink with pomegranate, blueberry and pepper, 1.5% fat. Actimel contains vitamin B6 and D.",
    discount: 0,
  ...
  },
  {
    ...
    price: 115,
    description:
      "Thanks to the natural fermentation, the bread gets its expressive flavor, aroma and appearance.",
    discount: 0,
  ...
  },
  {
    ...
    price: 299,
    description:
      "Wheat and rye flour bread, flavored with prunes, apricots, raisins, hazelnuts and peanuts, sunflowers.",
    discount: 0,
  ...
  },
  {
    ...
    price: 999,
    description:
      "Mascarpone cheese pie with fresh strawberries and blackberries with a sweet and sour cranberry jam layer.",
    discount: 0,
  ...
  },
  {
    ...
    price: 1799,
    description:
      "Almonds are high in protein and fiber and relatively low in fat—especially saturated fat.",
    discount: 20,
  ...
  },
  {
    ...
    price: 998,
    description:
      "Chocolate LION candies are made of waffle, caramel, crispy flakes and milk chocolate glaze.",
    discount: 20,
  ...
  },
  {
    ...
    price: 995,
    description:
      "Chocolate candy BOUNTY - a coconut base covered with thick milk chocolate.",
    discount: 0,
  ...
  },
  {
    ...
    price: 1000,
    description:
      "Decaf coffee is grown in Colombia. In the aroma, orange peel and cocoa are felt.",
    discount: 0,
  ...
  },
  {
    ...
    price: 149,
    description:
      "Lettuce is reddish-curled with green veins. Suitable for salads and sandwiches.",
    discount: 0,
  ...
  },
  {
    ...
    price: 159,
    description:
      "Kiwis are sweet, sometimes with a bit of croissants, tasting best when eaten fresh.",
    discount: 10,
  ...
  },
  {
    ...
    price: 65,
    description:
      "Mango fruit is perfect for tasting one, flavoring fruit salads and other desserts.",
    discount: 0,
  ...
  },
  {
    ...
    price: 129,
    description:
      "Broccoli is a popular vegetable that is high in many nutrients, including fiber and vitamin C.",
    discount: 0,
  ...
  },
  {
    ...
    price: 63,
    description:
      "Avocado is considered a nutritious fruit and contains higher quantities of soluble and insoluble fiber and protein than many other fleshy fruits.",
    discount: 15,
  ...
  },
  {
    ...
    price: 439,
    description:
      "Fresh pork sausages seasoned with pepper and other spices. Can be grilled.",
    discount: 0,
  ...
  },
  {
    ...
    price: 138,
    description:
      "Apple, orange and carrot juice, not made from concentrate. No added sugar.",
    discount: 0,
  ...
  },
  {
    ...
    price: 229,
    description:
      "Water, pink grapefruit juice (52%) from concentrated pink grapefruit juice, sugar, grapefruit pulp (3%).",
    discount: 0,
  ...
  },
  {
    ...
    price: 65,
    description:
      "Natural mineral water. Sodium (339 mg / l), calcium (98 mg / l), magnesium (20 mg / l), chlorine (520 mg / l), bicarbonates (355 mg / l), sulfates (17 mg / l), fluorine ( 0.2 mg / l).",
    discount: 0,
